...
mammals_native_ED_map =
  ...
  geom_sf(data = countries, color = 'gray', fill = NA) +
  geom_sf(data = bb, color = "gray", fill = NA) +
  geom_sf(data = (ED_mammal_native_sf %>% filter(!(Island == 1 & 
                                                   Area < 1e4))),
          aes(fill = f_mean_ED),
          color = NA, dTolerance = 2, linewidth = 0.2, show.legend = F) +
  ...
  #ggplot()+
  # Circle layer for islands, colored by PE and sized by richness
  geom_point(data = (ED_mammal_native_sf %>% filter(Island == 1 & 
                                                            Area < 1e4)),
             aes(x = Lon, y = Lat, color = f_mean_ED),
             size = 3,
             shape = 21, stroke = 2, fill = NA, show.legend = F) + 
  scale_color_manual(
    values = colors2,
...
colnames(sp_dis_5)
sp_dis_5 = sp_dis_5 %>% as.data.frame()
...
sp_dis_6 = sp_dis_5[,which(colnames(sp_dis_5) %in% colnames(sp_overlap_dat_2))]
...
mammals_extant_ED_map =
  ...
  geom_sf(data = countries, color = 'gray', fill = NA) +
  geom_sf(data = bb, color = "gray", fill = NA) +
  geom_sf(data = (ED_mammal_extant_sf %>% filter(!(Island == 1 & 
                                                   Area < 1e4))),
          aes(fill = f_mean_ED),
          color = NA, dTolerance = 2, linewidth = 0.2, show.legend = F) +
  ...
  #ggplot()+
  # Circle layer for islands, colored by PE and sized by richness
  geom_point(data = (ED_mammal_extant_sf %>% filter(Island == 1 & 
                                                      Area < 1e4)),
             aes(x = Lon, y = Lat, color = f_mean_ED),
             size = 3,
             shape = 21, stroke = 2, fill = NA, show.legend = F) + 
...
Delta_ED_mammal$delta_mean_EDR = log(Delta_ED_mammal$mean_all_EDR / 
                                     Delta_ED_mammal$mean_native_EDR)
...
mammals_delta_ED_map =
  ...
  geom_sf(data = countries, color = 'gray', fill = NA) +
  geom_sf(data = bb, color = "gray", fill = NA) +
  geom_sf(data = (Delta_ED_mammal_sf %>% filter(!(Island == 1 & 
                                                  Area < 1e4))),
          aes(fill = f_delta_mean_ED),
          color = NA, dTolerance = 2, linewidth = 0.2, show.legend = F) +
  ...
  #ggplot()+
  # Circle layer for islands, colored by PE and sized by richness
  geom_point(data = (Delta_ED_mammal_sf %>% filter(Island == 1 & 
                                                      Area < 1e4)),
             aes(x = Lon, y = Lat, color = f_delta_mean_ED),
             size = 3,
             shape = 21, stroke = 2, fill = NA, show.legend = F) + 
  scale_color_manual(
    values = colors4,
...
plants_native_ED_map =
  ...
  geom_sf(data = countries, color = 'gray', fill = NA) +
  geom_sf(data = bb, color = "gray", fill = NA) +
  geom_sf(data =  (ED_plant_native_sf %>% filter(!(Island == 1 & 
                                                   Area < 1e4))),
          aes(fill = f_mean_ED),
          color = NA, dTolerance = 2, linewidth = 0.2, show.legend = F) +
  ...
  #ggplot()+
  # Circle layer for islands, colored by PE and sized by richness
  geom_point(data = (ED_plant_native_sf %>% filter(Island == 1 & 
                                                      Area < 1e4)),
             aes(x = Lon, y = Lat, color = f_mean_ED),
             size = 3,
             shape = 21, stroke = 2, fill = NA, show.legend = F) +  
...
plants_extant_ED_map =
  ...
  geom_sf(data = countries, color = 'gray', fill = NA) +
  geom_sf(data = bb, color = "gray", fill = NA) +
  geom_sf(data = (ED_plant_extant_sf %>% filter(!(Island == 1 & 
                                                  Area < 1e4))),
          aes(fill = f_mean_ED),
          color = NA, dTolerance = 2, linewidth = 0.2, show.legend = F) +
  ...
  #ggplot()+
  # Circle layer for islands, colored by PE and sized by richness
  geom_point(data = (ED_plant_extant_sf %>% filter(Island == 1 & 
                                                      Area < 1e4)),
             aes(x = Lon, y = Lat, color = f_mean_ED),
             size = 3,
             shape = 21, stroke = 2, fill = NA, show.legend = F) + 
...
plants_delta_ED_map =
  ...
  geom_sf(data = countries, color = 'gray', fill = NA) +
  geom_sf(data = bb, color = "gray", fill = NA) +
  geom_sf(data = (Delta_ED_plant_sf %>% filter(!(Island == 1 & 
                                                 Area < 1e4))),
          aes(fill = f_delta_mean_ED),
          color = NA, dTolerance = 2, linewidth = 0.2, show.legend = F) +
  ...
  #ggplot()+
  # Circle layer for islands, colored by PE and sized by richness
  geom_point(data = (Delta_ED_plant_sf %>% filter(Island == 1 & 
                                                     Area < 1e4)),
             aes(x = Lon, y = Lat, color = f_delta_mean_ED),
             size = 3,
             shape = 21, stroke = 2, fill = NA, show.legend = F) + 
...
ED_bird_exotic_1 = cbind(RegionID = df$RegionID,
                         ED_bird_exotic$df)
ED_bird_exotic_sf = df_trans %>% left_join(ED_bird_exotic_1, by = 'RegionID')
...
birds_native_ED_map =
  ...
  geom_sf(data = countries, color = 'gray', fill = NA) +
  geom_sf(data = bb, color = "gray", fill = NA) +
  geom_sf(data = (ED_bird_native_sf %>% filter(!(Island == 1 & 
                                                   Area < 1e4))),
          aes(fill = f_mean_ED),
          color = NA, dTolerance = 2, linewidth = 0.2, show.legend = F) +
  ...
  #ggplot()+
  # Circle layer for islands, colored by PE and sized by richness
  geom_point(data = (ED_bird_native_sf %>% filter(Island == 1 & 
                                                      Area < 1e4)),
             aes(x = Lon, y = Lat, color = f_mean_ED),
             size = 3,
             shape = 21, stroke = 2, fill = NA, show.legend = F) + 
...
ED_bird_extant_1 = cbind(RegionID = df_trans$RegionID,
                         ED_bird_extant$df)
ED_bird_extant_sf = df_trans %>% left_join(ED_bird_extant_1, by = 'RegionID')
...
birds_extant_ED_map =
  ...
  geom_sf(data = countries, color = 'gray', fill = NA) +
  geom_sf(data = bb, color = "gray", fill = NA) +
  geom_sf(data = (ED_bird_extant_sf %>% filter(!(Island == 1 & 
                                                 Area < 1e4))),
          aes(fill = f_mean_ED),
          color = NA, dTolerance = 2, linewidth = 0.2, show.legend = F) +
  ...
  #ggplot()+
  # Circle layer for islands, colored by PE and sized by richness
  geom_point(data = (ED_bird_extant_sf %>% filter(Island == 1 & 
                                                      Area < 1e4)),
             aes(x = Lon, y = Lat, color = f_mean_ED),
             size = 3,
             shape = 21, stroke = 2, fill = NA, show.legend = F) + 
...
birds_delta_ED_map =
  ...
  geom_sf(data = countries, color = 'gray', fill = NA) +
  geom_sf(data = bb, color = "gray", fill = NA) +
  geom_sf(data = (Delta_ED_bird_sf %>% filter(!(Island == 1 & 
                                                Area < 1e4))),
          aes(fill = f_delta_mean_ED),
          color = NA, dTolerance = 2, linewidth = 0.2, show.legend = F) +
  ...
  #ggplot()+
  # Circle layer for islands, colored by PE and sized by richness
  geom_point(data = (Delta_ED_bird_sf %>% filter(Island == 1 & 
                                                     Area < 1e4)),
             aes(x = Lon, y = Lat, color = f_delta_mean_ED),
             size = 3,
             shape = 21, stroke = 2, fill = NA, show.legend = F) + 
...
df_trans = st_read("data/Fishes/data/Basin042017_3119.shp")
...
fishes_native_ED_map =
  ...
  geom_sf(data = countries, color = 'gray', fill = NA) +
  geom_sf(data = bb, color = "gray", fill = NA) +
  geom_sf(data = (ED_fish_native_sf %>% filter(!(Island == 1 & 
                                                  Surf_area < 1e4))),
          aes(fill = f_mean_ED),
          color = NA, dTolerance = 2, linewidth = 0.2, show.legend = F) +
  ...
  #ggplot()+
  # Circle layer for islands, colored by PE and sized by richness
  geom_point(data = (ED_fish_native_sf %>% filter(Island == 1 & 
                                                 Surf_area < 1e4)),
             aes(x = Lon, y = Lat, color = f_mean_ED),
             size = 3,
             shape = 21, stroke = 2, fill = NA, show.legend = F) + 
...
fishes_extant_ED_map =
  ...
  geom_sf(data = countries, color = 'gray', fill = NA) +
  geom_sf(data = bb, color = "gray", fill = NA) +
  geom_sf(data = (ED_fish_extant_sf %>% filter(!(Island == 1 & 
                                                 Surf_area < 1e4))),
          aes(fill = f_mean_ED),
          color = NA, dTolerance = 2, linewidth = 0.2, show.legend = F) +
  ...
  #ggplot()+
  # Circle layer for islands, colored by PE and sized by richness
  geom_point(data = (ED_fish_extant_sf %>% filter(Island == 1 & 
                                                    Surf_area < 1e4)),
             aes(x = Lon, y = Lat, color = f_mean_ED),
             size = 3,
             shape = 21, stroke = 2, fill = NA, show.legend = F) + 
...
fishes_delta_ED_map =
  ...
  geom_sf(data = countries, color = 'gray', fill = NA) +
  geom_sf(data = bb, color = "gray", fill = NA) +
  geom_sf(data = (Delta_ED_fish_sf %>% filter(!(Island == 1 & 
                                                Surf_area  < 1e4))),
          aes(fill = f_delta_mean_ED),
          color = NA, dTolerance = 2, linewidth = 0.2, show.legend = F) +
  ...
  #ggplot()+
  # Circle layer for islands, colored by PE and sized by richness
  geom_point(data = (Delta_ED_fish_sf %>% filter(Island == 1 & 
                                                 Surf_area < 1e4)),
             aes(x = Lon, y = Lat, color = f_delta_mean_ED),
             size = 3,
             shape = 21, stroke = 2, fill = NA, show.legend = F) +
...
##### Mean ED #####
# Compare the ED patterns of natives, native + exotics, and their differences
