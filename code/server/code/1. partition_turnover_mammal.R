...
system.time({
  delta_pu_mammal_list = future_map(
    ...
    function(x) {
      ...
      ## Pathways 3&5
      sp_mammal_path3_5 = rbind(sp_dis_6, 
                             natu_region1,
                             natu_no_region1)
      ...
      phy_uniq_mammal_path3_5 = calcu_phy_turn_focal_mean(
        tree = phylo_mammal_extant,
        x = mat_mammal_path3_5,
        focal_region = region1)
      delta_pu = phy_uniq_mammal_path3_5 - mean(phy_turn_mammal_native[,region1])
      
      phy_uniq_mammal_real = calcu_phy_turn_focal_mean(
        tree = phylo_mammal_extant,
        x = mat_mammal_extant,
        focal_region = region1)
      phy_uniq_mammal_real - mean(phy_turn_mammal_native[,region1])
