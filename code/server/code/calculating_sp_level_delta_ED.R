...
mod_plant_sp_inv_ed_inla = inla(presence ~ delta_exo_nat + f(Region_id, model="iid")  
...
save(mod_plant_sp_inv_ed_inla,
     file = 'results/primary_results/mod_plant_sp_inv_ed_inla.rdata')
#load('results/primary_results/mod_plant_sp_inv_ed_inla.rdata')
summary(mod_plant_sp_inv_ed_inla)
...
save(lincombs.plant.data.estab.delta_e_n_single, 
     file = 'results/primary_results/lincombs.plant.data.estab.delta_e_n_single.rdata')
...
#load('results/primary_results/mod_bird_sp_inv_ed_inla.rdata')
...
load('results/primary_results/mod_fish_sp_inv_ed_inla.rdata')
