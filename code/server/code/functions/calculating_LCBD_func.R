...
requirements = c("PhyloMeasures", "phangorn", "parallel", "dplyr",
                 "ape", 'phyloregion', 'ade4', 'adespatial')
#require('adespatial')
...
#load('/home/yaoqi/my_pc/Global_ED/results/primary_results/LCBD_plant_native.rdata')
#phylo_sim_all_0 = LCBD_plant_native$beta_mat
...
calcu_LCBD_parallel = function(Tree, Comm, Region_posi) {
  ...
  summary(LCBD_simp$LCBD)
  #save data
  LCBD_simp_geo = data.frame(RegionID = attr(dissimilarities, "Labels"),
                             LCBD = LCBD_simp$LCBD, 
